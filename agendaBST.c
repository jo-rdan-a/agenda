...
// Função para inserir um contato na BST
...
// Função para remover um contato da BST
...
// Função para exibir os contatos (em ordem) na interface
...
// Função para buscar um contato na BST
